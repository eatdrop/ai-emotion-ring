...
| `data` | Backend primary, reviewed by all | Dictionaries, schemas, synthetic samples, governance | Review by all affected roles |
...
- A directory owner is accountable for technical quality and final merging; ownership does not remove review requirements.
